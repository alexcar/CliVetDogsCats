...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230502153605_Alter-Schedule-v2")]
    partial class AlterSchedulev2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Schedule", b =>
                {
                    ...
                    b.Property<DateTime?>("ScheduleCancellation")
                        .HasColumnType("datetime2");

                    b.Property<string>("ScheduleComments")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entities.ScheduleProduct", b =>
                {
                    b.Property<Guid>("ProductId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.Schedule", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ScheduleStatus", "ScheduleStatus")
                        .WithMany()
